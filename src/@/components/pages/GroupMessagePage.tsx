...
const GroupHeader = lazy(() => import("../shared/GroupHeader"));
const GroupMessageInput = lazy(() => import("../shared/GroupMessageInput"));
const GroupInfoSidebar = lazy(() => import("../shared/GroupInfoSidebar"));
...
export default function GroupMessagePage() {
  ...
  // Adding and removing groupId from socket
  useEffect(() => {
    if (groupId && socket) {
  ...
  if (!isUserGroupMember && !isLoading) {
    content = (
